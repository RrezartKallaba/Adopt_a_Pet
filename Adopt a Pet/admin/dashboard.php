            ...
            <div class="row">
                <div class="col left-column">
                    <div class="fixed-header">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="<?php isActive($page, 'animals'); ?>"><a href="?page=animals">Animals</a></li>
                            <li class="<?php isActive($page, 'create_animal'); ?>"><a href="?page=create_animal">Create a animal</a></li>
                ...
                <div class="col right-column">
                    ...
                    if ($page === 'users') {
                        ...
                        include "profile.php";
                    } elseif ($page === 'create_animal') {
                        include "create_animal.php";
                    } elseif ($page === 'create_user') {
                        include "create_user.php";
                    } elseif ($page === 'update_animal') {
                        // Check if the "animal_id" query parameter is set
                        if (isset($_GET['animal_id'])) {
                            // Include "update_animal.php" and pass the "animal_id" to the included file
                            $animal_id = $_GET['animal_id'];
                            include "update_animal.php";
                        } else {
                            // Redirect or display an error message if "animal_id" is not provided
                            echo "Error: Animal ID not provided.";
                        }
                    } elseif ($page === 'details_animal') {
                        // Check if the "animal_id" query parameter is set
                        if (isset($_GET['animal_id'])) {
                            // Include "update_animal.php" and pass the "animal_id" to the included file
                            $animal_id = $_GET['animal_id'];
                            include "details_animal.php";
                        } else {
                            // Redirect or display an error message if "animal_id" is not provided
                            echo "Error: Animal ID not provided.";
                        }
